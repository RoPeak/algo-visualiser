...
export const AlgorithmInfo = ({ algorithm, description, isSorting }: AlgorithmInfoProps) => {
    ...
    return (
        <div className="h-full w-full p-6 bg-gray-800/80 rounded-xl border border-gray-700 backdrop-blur-sm space-y-4 flex flex-col">
            ...
            <div className="pt-4 border-t border-gray-700 flex-1 flex flex-col">
